...
from utilities import MoCoDatasetRegressionUpdated, tensorboard_regression, getSSIM


device = torch.device("cuda:0") # if torch.cuda.is_available() and cuda else "cpu")
log_path = './TBLogs'
trainID = 'RN18-Regression'
save_path = './Results'
...
traindata = glob('./train/*.nii.gz')
valdata = glob('./val/*.nii.gz')
